...
export function compile(project, options = {}) {
  return build(project, options, true);
}

// The exact conversion front end, without code generation or execution.
export function validate(project, options = {}) {
  build(project, options, false);
}

function build(project, options, emitCode) {
